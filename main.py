            ...
            if Password == "1234":
                ...
                if AdminOptions == "1":  # Admin mode --> Pateints Management
                    ...
                    if Admin_choice == "1":  # Admin mode --> Pateints Management --> Enter new patient data
                        ...
                        try:  # To avoid non integer input
                            patient_ID = int(input("Enter patient ID : "))
                            while patient_ID not in Pat_DataBase:
                                patient_ID = int(input("Incorrect ID, Please Enter patient ID : "))
                            print("\npatient name        : ", Pat_DataBase[patient_ID][2])
                            print("patient age         : ", Pat_DataBase[patient_ID][3])
                            print("patient gender      : ", Pat_DataBase[patient_ID][4])
                            print("patient address     : ", Pat_DataBase[patient_ID][5])
                            print("patient room number : ", Pat_DataBase[patient_ID][6])
                            print("patient is in " + Pat_DataBase[patient_ID][0] + " department")
                    ...
                    if Admin_choice == "1":  # Admin mode --> Doctors Management --> Enter new doctor data
                        try:  # To avoid non integer input
                            ...
                            Doc_DataBase[Doctor_ID] = [[Department, Name, Address]]
                        ...
                        try:  # To avoid non integer input
                            Doctor_ID = int(input("Enter doctor ID : "))
                            while Doctor_ID not in Doc_DataBase:
                                Doctor_ID = int(input("Incorrect ID, Please Enter Correct doctor ID : "))
                            print("Doctor name    : ", Doc_DataBase[Doctor_ID][0][1])
                            print("Doctor address : ", Doc_DataBase[Doctor_ID][0][2])
                    ...
                    if Admin_choice == "1":  # Admin mode --> Appointment Management --> Book an appointment
                        try:  # To avoid non integer input
                            ...
                            if Admin_choice == "1":
                                ...
                                while patient_ID in Pat_DataBase:  # if Admin entered used ID
                                    patient_ID = int(input("This ID is unavailable, please try another ID : "))
                                Department = Doc_DataBase[Doctor_ID][0][0]
                                DoctorName = Doc_DataBase[Doctor_ID][0][1]
                                Name = input("Enter patient name    : ")
                                Age = input("Enter patient age     : ")
                                Gender = input("Enter patient gender  : ")
                                Address = input("Enter patient address : ")
                            ...
                            Doc_DataBase[Doctor_ID].append(New_Appointment)
                        ...
                        try:  # To avoid non integer input
                            ...
                            try:  # To avoid no return function
                                ...
                                Doc_DataBase[PairKey][AppointmentIndex] = [patient_ID, Session_Start, Session_End]
                        ...
                        try:  # To avoid non integer input
                            ...
                            try:
                                AppointmentIndex, PairKey = AppointmentIndexInDoctorsDataBase(patient_ID)
                                Doc_DataBase[PairKey].pop(AppointmentIndex)
        ...
        while True:
            ...
            if UserOptions == "1":  # User mode --> view hospital's departments
                ...
                try:  # To avoid non integer input
                    ...
                    while patient_ID not in Pat_DataBase:
                        patient_ID = int(input("Incorrect Id, Please enter patient ID : "))
                    print("	patient name        : ", Pat_DataBase[patient_ID][2])
                    print("	patient age         : ", Pat_DataBase[patient_ID][3])
                    print("	patient gender      : ", Pat_DataBase[patient_ID][4])
                    print("	patient address     : ", Pat_DataBase[patient_ID][5])
                    print("	patient room number : ", Pat_DataBase[patient_ID][6])
                ...
                try:  # To avoid non integer input
                    ...
                    while Doctor_ID not in Doc_DataBase:
                        Doctor_ID = int(input("Incorrect Id, Please enter doctor ID : "))
                    print(Doc_DataBase[Doctor_ID][0][1] + " has appointments :")
                    for i in Doc_DataBase[Doctor_ID]:
                        if type(i[0]) == str:
                            continue
                        else:
